...
namespace Facile.Models
{
	...
	public class Clienti
	{
		...
		public double cli_fat_previsto { get; set; }
		...
		public DateTime bollini_data { get; set; }
		...
		public int cli_tab_ces { get; set; }
		public int cli_cod_ces { get; set; }
		public DateTime data_acquisiz { get; set; }
		...
		public int cli_listino_tra { get; set; }
		public int cli_codfor { get; set; }
		public int cli_ass_age { get; set; }
		public int cli_ass_pag { get; set; }
		public int cli_esc_fat { get; set; }
		public int cli_ditta_ind { get; set; }
		public double cli_anticipi { get; set; }
		public DateTime cli_data_cessazione { get; set; }
		public int cli_blocco_bollini { get; set; }
		public int cli_tab_gru { get; set; }
		public int cli_tab_att { get; set; }
		public int cli_livello { get; set; }
		...
		public int cli_ricevgg_0 { get; set; }
		public int cli_ricevgg_1 { get; set; }
		public int cli_ricevgg_2 { get; set; }
		...
		public int cli_chiusura { get; set; }
		...
		public double cli_pr1 { get; set; }
		public double cli_pr2 { get; set; }
		public double cli_pr3 { get; set; }
		public double cli_pr4 { get; set; }
