...
namespace Facile.Models
{
	...
	public class Artanag
	{
		...
		public double ana_pezzi_conf { get; set; }
		...
		public int ana_trasf1 { get; set; }
		public int ana_trasf2 { get; set; }
		public int ana_trasf3 { get; set; }
		public int ana_trasf4 { get; set; }
		...
		public int ana_tab_ta1 { get; set; }
		public int ana_tab_ta2 { get; set; }
		public int ana_tab_ta3 { get; set; }
		public int ana_tab_col { get; set; }
		...
		public int ana_tab_set { get; set; }
		public int ana_cod_set { get; set; }
		public DateTime ana_datainv { get; set; }
		public int ana_notrasf { get; set; }
		public int ana_esclis { get; set; }
		public int ana_quotazione { get; set; }
		public int ana_venapeso { get; set; }
		public int ana_complistino { get; set; }
		public int ana_plu { get; set; }
		public int ana_bancone { get; set; }
		public int ana_listino_comp { get; set; }
		public double ana_comp_pezzo { get; set; }
		public int ana_noagglis { get; set; }
		public int ana_fiscale { get; set; }
		public int ana_snregfispro { get; set; }
		public int ana_snallfispro { get; set; }
		public int ana_fktipfispro { get; set; }
		public string ana_serfispro { get; set; }
		public int ana_numfogpro { get; set; }
		public int ana_pti_erogati { get; set; }
		public int ana_pti_detratti { get; set; }
		public int ana_stbat { get; set; }
		public double ana_comp_nos { get; set; }
		public double ana_comp_age { get; set; }
		...
		public double ana_peso_sgo { get; set; }
		public double ana_perc_calo_peso { get; set; }
		...
		public int ana_premio { get; set; }
		public double ana_contributo { get; set; }
		public int ana_bollini { get; set; }
		public int ana_campagna_prec { get; set; }
		public int ana_noaggfor { get; set; }
		public int ana_ggscad { get; set; }
		public int ana_gest_lotti { get; set; }
		public int ana_moved { get; set; }
		public int ana_esc_statistiche { get; set; }
		...
		public int ana_tipo_gruppo { get; set; }
		...
		public int ana_tipo_web { get; set; }
		public double ana_altezza { get; set; }
		public double ana_larghezza { get; set; }
		public double ana_profondita { get; set; }
		public bool ana_imported { get; set; }
		public DateTime ana_last_import { get; set; }
		public int ana_eko_disponibilita { get; set; }
		public DateTime ana_eko_data_arrivo { get; set; }
		public int ana_tensione { get; set; }
		public int ana_classe_energetica { get; set; }
		public int ana_consumo { get; set; }
		...
		public double ana_accise { get; set; }
		public double ana_contrassegni { get; set; }
		public double ana_raee { get; set; }
		public double ana_conai { get; set; }
		public int ana_deleted { get; set; }
		public int ana_tab_mix { get; set; }
		public int ana_cod_mix { get; set; }
		public int ana_pti_max { get; set; }
